...
namespace WeChat.App_Start
{
    ...
    // 
    //  [DebuggerVisualizer(typeof(FilterConfig))]
    //  [Serializable]
    ...
    /// 一个 SomeType 的可视化工具。  
    /// </summary>
    public class FilterConfig : DialogDebuggerVisualizer
    {
        ...
        // 
        //    FilterConfig.TestShowVisualizer(new SomeType());
        // 
        /// <summary>
        ...
        {
            VisualizerDevelopmentHost visualizerHost = new VisualizerDevelopmentHost(objectToVisualize, typeof(FilterConfig));
