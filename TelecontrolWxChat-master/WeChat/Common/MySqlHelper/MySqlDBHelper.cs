...
namespace WeChat.MysqlDBHelper
{
    /// <summary>
    /// MySqlHelper操作类
    /// </summary>
    public sealed partial class MySqlDBHelper
    {
        /// <summary>
        /// 批量操作每批次记录数
        /// </summary>
        ...
        static Config.InfoCon _config = System.Web.Configuration.WebConfigurationManager.OpenWebConfiguration("~").GetSection("InfoCon") as InfoCon;
        /// <summary>
        /// 超时时间
        /// </summary>
        ...
        {
            this.ConnectionString = _config.ConnectionString;
        }
